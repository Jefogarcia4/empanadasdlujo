...
import { FaImage, FaMagic, FaTrashAlt } from 'react-icons/fa';
import {
  crearCategoria,
  crearProducto,
  crearSabor,
        ...
        <form className="pform" onSubmit={handleSubmit}>
          <div className="pform__body">
            ...
            <section className="pform__section">
              ...
              <div className="pform__imagen">
                <div className="pform__field">
                  <span className="pform__label">URL de la imagen</span>
                  <input
                    className="pform__input"
                    type="url"
                    maxLength={255}
                    placeholder="https://…/empanada-carne.png"
                    value={form.urlImage}
